                    ...
                    <div class="col-sm-12   panel  panel-info">
                        ...
                        <div class="row panel-body">
                            ...
                            <div class="col-sm-5 "><?php
                                ...
                                ?> </div>
                            <div class="col-sm-2 "><a href="<?php echo U("Article/index/single?id=".$value['id']); ?>">阅读全文</a></div>
                            <div class="col-sm-2 "><a href="<?php echo U("Article/index/single?id=".$value['id']."#comment"); ?>">评论 <span class="badge"><?php echo $value['comments_count']?></span></a></div>
                        </div>
                    </div>   
                    <?php
                }
