							...
							<div class="media">
								...
								<div class="media-body">
									...
									<p class="post-info">
										...
										<i class="glyphicon glyphicon-home"></i><a href="<?php echo U('post/group/index?id='.mc_get_meta($val['id'],'group')); ?>"><?php echo mc_get_page_field(mc_get_meta($val['id'],'group'),'title'); ?></a>
