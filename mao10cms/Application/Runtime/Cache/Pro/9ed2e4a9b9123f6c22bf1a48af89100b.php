<?php if (!defined('THINK_PATH')) exit();?><div id="comment">
	...
	<div class="media" id="comment-<?php echo $val['id']; ?>">
		...
		<div class="media-body">
			<h4 class="media-heading">
				...
				<?php if(mc_is_admin()) : ?><a class="btn btn-danger btn-xs pull-right" href="<?php echo U('home/perform/comment_delete?id='.$val['id']); ?>">删除</a><?php elseif(mc_comment_group($val['id']) && mc_get_meta($val['user_id'],'group_admin',true,'user')==mc_comment_group($val['id'])) : endif; ?>
			</h4>
